...
const TaglineCTA: React.FC = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#f9b918] via-[#fbc02d] to-[#fcc319] py-16 md:py-20">
      ...
      <div className="container relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        ...
        <Reveal direction="left" delay={0.3} className="lg:col-span-5">
