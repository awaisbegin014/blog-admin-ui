...
const Testimonials: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -bottom-32 -right-32 w-96 h-96 bg-amber-300/25 rounded-full blur-3xl pointer-events-none" />

      <div className="container relative z-10 px-4 sm:px-6 lg:px-8">
        {/* Section Header */}
        <Reveal className="mb-10 md:mb-14 flex flex-col md:flex-row md:items-end justify-between gap-6">
